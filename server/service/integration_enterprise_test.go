...
func (s *integrationEnterpriseTestSuite) TestHostDeviceMappingIDP() {
	...
	s.DoJSON("PUT", fmt.Sprintf("/api/latest/fleet/hosts/%d/device_mapping", host.ID),
		putHostDeviceMappingRequest{Email: "any.username@example.com", Source: fleet.DeviceMappingMDMIdpAccounts},
		http.StatusOK, &putResp)
	...
	s.DoJSON("PUT", fmt.Sprintf("/api/latest/fleet/hosts/%d/device_mapping", host.ID),
		putHostDeviceMappingRequest{Email: "nonscim@example.com", Source: fleet.DeviceMappingMDMIdpAccounts},
		http.StatusOK, &putResp)
